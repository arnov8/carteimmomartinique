...
interface DemoMobileLayerSheetProps {
...
export function MobileLayerButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
...
export default function DemoMobileLayerSheet({
  activeLayers,
  onToggleLayer,
  currentZoom,
  filters,
  onFiltersChange,
}: DemoMobileLayerSheetProps) {
